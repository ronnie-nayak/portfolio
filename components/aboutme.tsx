    ...
    <div id="about" className="p-9 sm:pt-40">
      ...
      <div className="flex flex-col-reverse sm:flex-row gap-10">
        <div className="bg-[F5F5F5] sm:text-[1.5vw] w-full font-bold">
          <p className="mb-9">
            I'm a Full Stack Developer working in developing web solutions for a variety of clients. My skillset lies in delivering an end-to-end approach for business use-cases while delivering a seamless user experience.
          </p>
          <p className="mb-24">
            I like to dive into the conplexities of todays tech environment while experiencing and growing with the community. I am passionate about the field and there is nothing better than having like-minded people to share your pursuits with.
          </p>
          ...
          <h2 className="mt-40 sm:text-[2vw] font-bold underline">Technologies I have worked with:-</h2>
        </div>

        <div className="w-full sm:text-[1.5vw] flex flex-col items-center">
          <div className="w-96 h-96 rounded-full border-8 border-double border-gray-500" style={{
          ...
          <div className="flex gap-16 items-center">
            <Link href="https://github.com/ronnie-nayak">
              <Image alt="github" src="/github.svg" width={90} height={90} />
            </Link>
            <Link href="https://www.linkedin.com/in/abhishek-r-nayak/">
              <Image alt="linkedin" src="/linkedin.svg" width={110} height={110} />
            </Link>
            <Link href="https://wa.me/919821245180?text=Hey%20let's%20chat">
              <Image alt="whatsapp" src="/whatsapp.svg" width={110} height={110} />
            </Link>
          </div>
        </div >
